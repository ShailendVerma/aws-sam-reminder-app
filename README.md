...
* sam deploy --template-file /Users/anushreegarg/shail/AWS/sam/reminder-app/sam-app/package.yaml --stack-name remApp1 --capabilities CAPABILITY_IAM --parameter-overrides Stage=dev AppName=RemApp
